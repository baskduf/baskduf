...
* **[SSAFY-QUEST](https://ssafy-quest.vercel.app/)**: 알고리즘 연습 게임화 서비스 (실사용자 **130명+**)
* **영남대학교 앱 공모전 1위**: 통합 민원 포털 서비스 개발 (Flutter)
...
- **Anime**: *Steins;Gate*, *Evangelion* 같은 깊이 있는 세계관의 작품을 좋아합니다.
